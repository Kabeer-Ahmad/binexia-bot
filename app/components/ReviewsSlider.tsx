      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
            ...
            <strong className="text-green-400">successful traders</strong> are saying
          </p>
        </motion.div>
              ...
              <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  {testimonials[currentIndex].verified && (
                    <div className="mb-4 text-sm font-semibold text-green-400 bg-green-900/20 inline-block px-4 py-1 rounded-full">
                      ✓ VERIFIED USER
                    </div>
                  )}
        ...
        >
          <p className="text-2xl md:text-3xl font-bold text-white mb-8">
            Your success story could be <span className="text-green-400">next</span>
          </p>
          <motion.a
            href="/signup"
            whileHover={{
